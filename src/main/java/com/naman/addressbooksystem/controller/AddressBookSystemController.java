...
public class AddressBookSystemController {
    ...
    public ResponseEntity<ResponseDTO> createAddressBookContact(@Valid @RequestBody AddressBookDataDTO addressBookDataDTO) {
    ...
    public ResponseEntity<ResponseDTO> updateAddressBookContact(@PathVariable("contactId") int contactId,@Valid @RequestBody AddressBookDataDTO addressBookDataDTO) {
